            ...
            if (paramType == 1) { //文本编辑框
                ...
                if (defaultValue != '') {
                    if (defaultValue == 'true') { // true
                        str = '<input type="checkbox" name="' + paramName + '" title="选中" checked><span style="margin-left: 10px;">选中</span>';
                    } else {
                        //false
                        str = '<input type="checkbox" name="' + paramName + '" title="选中"><span style="margin-left: 10px;">选中</span>';
                    }
                } else {
                    str = '<input type="checkbox" name="' + paramName + '" title="选中"><span style="margin-left: 10px;">选中</span>';
                }
